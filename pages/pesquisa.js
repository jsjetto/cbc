    ...
    <div className='pt-6' >
      ...
      {!sucess &&
        <div className='w-1/5 mx-auto'>
          ...
          <input type='/text' className='p-4 block shadow bg-blue-200 my-1 rounded-lg' placeholder='Nome' onChange={onChange} name='Nome' value={form.Nome} />
          <label className='font-bold'>E-mail:</label>
          <input type='/text' className='p-4 block shadow bg-blue-200 my-1 rounded-lg' placeholder='Email' onChange={onChange} name='Email' value={form.Email} />
          <label className='font-bold'>Whatsapp:</label>
          <input type='/text' className='p-4 block shadow bg-blue-200 my-1 rounded-lg' placeholder='Whatsapp' onChange={onChange} name='Whatsapp' value={form.Whatsapp} />
          ...
          <input type='/text' maxLength="150" className='p-4 block shadow bg-blue-200 my-1 rounded-lg' placeholder='CriticaSugestão' onChange={onChange} name='Critica' value={form.Critica} />
